 ...
 *
 * The MetusV2 extension injects the required cookies and CORS headers automatically
...
const API = (function () {
  ...
  function getToken() {
    ...
    if (!t) throw new Error('Not authenticated. Please ensure the MetusV2 extension is installed and you are logged into Facebook.');
    return t;
  }
